...
Theorem index_after_last: forall (n : nat) (X : Type) (l : list X),
     ...
     index (S n) l = None.
Proof.
intros.   generalize dependent n. induction l as [| h l'].
Case " l = nil ". intros n H1. simpl in H1.
rewrite <- H1. reflexivity.

Case "l = h :: l'".
simpl. intros.  rewrite <- H. apply IHl'. reflexivity. Qed.
...
Case "beq nat k1 k2 = false".  reflexivity. Qed.
  (* FILL IN HERE *) 
(** [] *)
